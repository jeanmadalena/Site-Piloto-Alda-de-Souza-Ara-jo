...
import { X, Lock, ShieldCheck, User, ExternalLink, KeyRound, AlertCircle, Calendar, Folder } from 'lucide-react';
...
export const RestrictedAreaModal: React.FC<RestrictedAreaModalProps> = ({
  ...
  const handleAccessReservas = () => {
    window.open(SCHOOL_INFO.reservasAldaUrl, '_blank', 'noopener,noreferrer');
    onClose();
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm p-4 animate-fadeIn">
      <div className="bg-white rounded-3xl max-w-md w-full p-6 sm:p-8 shadow-2xl relative space-y-5 animate-scaleUp">
        {/* Botão Fechar */}
        <button
          onClick={() => {
            handleReset();
